#ifndef THREECAMSVIDEROSTITCHING_H
#define THREECAMSVIDEROSTITCHING_H
...
using namespace std;
namespace Ui {
class threeCamsVideroStitching;
}

class threeCamsVideroStitching : public QWidget
{
    Q_OBJECT

public:
    explicit threeCamsVideroStitching(QWidget *parent = 0);
    ~threeCamsVideroStitching();
...
private:
    Ui::threeCamsVideroStitching *ui;
...
#endif // THREECAMSVIDEROSTITCHING_H
